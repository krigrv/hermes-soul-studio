...
const TONE = {
  error: { Icon: AlertTriangle, color: "text-red-300", bg: "bg-red-500/10", border: "border-red-500/30" },
  warn: { Icon: AlertTriangle, color: "text-amber-300", bg: "bg-amber-500/10", border: "border-amber-500/30" },
  info: { Icon: Info, color: "text-sky-300", bg: "bg-sky-500/10", border: "border-sky-500/30" },
};
